...
found = stop_data.detectMultiScale(img_gray_rotated, scaleFactor=1.05,
...
if amount_found != 0:
    ...
    for (x, y, width, height) in found:
        ...
        x = int(x * img.shape[1] / img_gray_rotated.shape[1])
        y = int(y * img.shape[0] / img_gray_rotated.shape[0])
        width = int(width * img.shape[1] / img_gray_rotated.shape[1])
        height = int(height * img.shape[0] / img_gray_rotated.shape[0])
